...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybaobabdt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14986&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybaobabdt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybaobabdt` can be installed with:

```
conda install pybaobabdt
```

It is possible to list all of the versions of `pybaobabdt` available on your platform with:
